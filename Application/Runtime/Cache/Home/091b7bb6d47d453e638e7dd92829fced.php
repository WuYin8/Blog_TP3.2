...
<link rel="stylesheet" type="text/css" href="/public/public/bootstrap3/css/bootstrap.css">
  <link rel="stylesheet" type="text/css" href="/public/public/bootstrap3/js/bootstrap.min.js">
  <link rel="stylesheet" type="text/css" href="/public/public/bootstrap3/js/bootstrap.js">
  <link rel="stylesheet" type="text/css" href="/public/public/bootstrap3/js/datetime.js">
...
<div class="logo">
  <a href="/index"><img src="/public/images/logo.png" class="img-responsive" alt="" title = "点击回到首页"></a>
<div class="user">
  <div class="cont_centrar">
    <div class="cont_login">
      ...
      <div class="cont_forms" >
        ...
        <form id="registerForm" method = "post" action = "/home/user/register">
          <div class="cont_form_sign_up"> <a href="#" onclick="ocultar_login_sign_up()">X</a>
           ...
           <input type="text" id="registerName" name = "registerName" placeholder="用户名长度为6~12位" />
            ...
            <input class = "phoneCode" id="code" name = "code" type="text" style="width:100px;" placeholder="手机验证码" />
            ...
            <script>
              function getcode()
              {
                ...
                $.get('/home/user/code',{phone:phone},function(date){
                  console.log(date);
                });
              }
            </script>
