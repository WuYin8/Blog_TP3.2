            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-6">
                       ...
                       <form action="/home/admin/contentUndel" method = "post">
                        <table class="table table-striped table-bordered table-hover">
                                <tr>
                                    <th><div style="width:60px;">选择</div></th>
                                    <th><div style="width:110px;">文章标题</div></th>
                                    <th>文章内容</th>
                                    <th><div style="width:80px;">发表时间</div></th>
                                    <th><div style="width:30px;">删除</div></th>
                                </tr>
                                 <?php if(!empty($contents)): if(is_array($contents)): foreach($contents as $key=>$vContent): ?><tr>
                                    <td><input type = "checkbox" name = "id[]" value = "<?php echo ($vContent["id"]); ?>"/></td>
                                    <td><a href="/home/single/single?sid=<?php echo ($vContent["id"]); ?>"><?php echo ($vContent["title"]); ?></a></td>
                                    <td><div style="width:550px; max-height: 120px; overflow: hidden; text-overflow: ellipsis;"><?php echo ($vContent["content"]); ?></div></td>
                                    <td><?php echo (date("Y-m-d h:i:s",$vContent["addtime"])); ?></td>
                                    <td>
                                        <a href="/home/admin/contentShit?sid=<?php echo ($vContent["id"]); ?>" onclick="alert('该文章下的回复会一起删除')">删除
                                    </td>
