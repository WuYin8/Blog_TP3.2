            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-6">
                       ...
                       <form action="/home/admin/replyUndel" method = "post">
                        <table class="table table-striped table-bordered table-hover">
                                ...
                                <?php if(!empty($replys)): if(is_array($replys)): foreach($replys as $key=>$vReply): ?><tr>
                                    <td><input type = "checkbox" name = "id[]" value = "<?php echo ($vReply["id"]); ?>"/></td>
                                    <td><div style="width:550px; max-height: 120px; overflow: hidden; text-overflow: ellipsis;"><?php echo ($vReply["content"]); ?></div></td>
                                    <td align="centet"><?php echo (date("Y-m-d h:i:s",$vReply["addtime"])); ?></td>
                                    <td>
                                        <a href="/home/admin/replyShit?sid=<?php echo ($vReply["id"]); ?>">删除
                                    </td>
